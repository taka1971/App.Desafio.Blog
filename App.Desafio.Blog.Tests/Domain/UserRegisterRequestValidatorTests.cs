...
namespace App.Desafio.Blog.Tests.Domain
{
    public class UserRegisterRequestValidatorTests
    {
        ...
        {
            var model = new UserRegisterRequest(null, "email@challenger.com", "password123");
        ...
        {
            var model = new UserRegisterRequest(new string('a', 101), "email@challenger.com", "password123");
            var result = _validator.TestValidate(model);
            result.ShouldHaveValidationErrorFor(request => request.Username)
        ...
        {
            var model = new UserRegisterRequest("username", "email@challenger.com", "pass");
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new UserRegisterRequest("username", "email@challenger.com", "password123");
            var result = _validator.TestValidate(model);
